...
const PUBLIC_REVEAL = process.env.NEXT_PUBLIC_REVEAL_DATETIME || "2026-07-23T16:45:00-03:00";
      ...
      <div className="card">
        ...
        <div className="grid three" style={{ marginTop: 24 }}>
          <section className="section">
            <h2>👥 Participantes</h2>
            <p className="countdown">{data.participants.length}</p>
          </section>
          <section className="section">
            <h2>🎲 Sorteo</h2>
          ...
          <section className="section">
            <h2>✉️ Pistas</h2>
            <p className="countdown">{data.clues.length}</p>
          </section>
        </div>
        ...
        <div className="grid two" style={{ marginTop: 18 }}>
          ...
          <section className="section">
            ...
            <p className="muted">Copiá el código de cada persona y mandáselo por Teams o WhatsApp.</p>
