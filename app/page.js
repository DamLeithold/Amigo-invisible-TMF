...
const EVENT_DATETIME = process.env.NEXT_PUBLIC_EVENT_DATETIME || "2026-07-23T16:45:00-03:00";
...
function revealEnabled() {
  return new Date().getTime() >= new Date(REVEAL_DATETIME).getTime();
}

function formatRevealDate() {
  return "23 de julio a las 16:45 hs";
}
...
export default function Home() {
  ...
  useEffect(() => {
    const t = setInterval(() => setCanReveal(revealEnabled()), 30000);
    ...
    return (
      <main>
        <div className="card small-card">
          <div className="brand">
            <img src="/tmf-logo.jpg" className="logo-img" alt="TMF Group" />
            <div>
              <h1>{EVENT_NAME}</h1>
              <p className="muted">Buzón digital para pistas y regalos.</p>
            </div>
          </div>
      ...
      <div className="card">
        <div className="header">
          <div className="brand">
            ...
            <div>
              ...
              <span className="badge">16:45 hs</span>
        ...
        <div className="grid two" style={{ marginTop: 24 }}>
          ...
          <section className={canReveal ? "reveal-box" : "section"}>
            ...
            {!canReveal ? (
              <>
                <p>Esta opción se habilita automáticamente el <b>{formatRevealDate()}</b>.</p>
                <p className="muted">Hasta ese momento, las pistas siguen siendo anónimas.</p>
              </>
            ) : !revealedSecret ? (
              <>
        ...
        <div className="grid two" style={{ marginTop: 18 }}>
          <section className="section">
            ...
            <p className="muted">Tu amigo verá la pista, pero no sabrá que fuiste vos hasta el 23/7 a las 16:45.</p>
